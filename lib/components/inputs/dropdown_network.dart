...
class DropdownNetwork extends StatefulWidget {
  ...
  @override
  State<DropdownNetwork> createState() => _RoundedDropdownState();
}

class _RoundedDropdownState extends State<DropdownNetwork> {
  String? _value;
